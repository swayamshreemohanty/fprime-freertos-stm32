...
#define  TICK_INT_PRIORITY            (15UL) /*!< tick interrupt priority (15 = lowest for FreeRTOS) */
#define  USE_RTOS                     0       /*!< HAL does not support USE_RTOS=1, FreeRTOS handles its own locking */
